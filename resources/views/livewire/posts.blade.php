...
<div class="max-w-6xl mx-auto sm:px-6 lg:px-8 mt-5">
                ...
                <button wire:click="showModal()" class="bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-4 rounded">
                                ...
                                @if(session()->has('info'))
                                    <div class="bg-green-500 border-2 border-green-600 rounded-b mb-2 py-3 px-3 mt-2">
                                        <div>
                    ...
                    <table class="table-fixed w-full mt-2">
                        <thead class="bg-blue-400">
                            <tr>
                                <th class="py-4 px-2 text-white">No</th>
                                <th class="py-4 px-2 text-white">Judul</th>
                                <th class="py-4 px-2 text-white">Deskripsi</th>
                                <th class="py-4 px-2 text-white">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
